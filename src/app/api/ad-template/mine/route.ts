...
const SHARE_ERRORS: Record<AdTemplateShareError, { zh: string; en: string }> = {
  ...
  wrong_kind: { zh: "这不是电商视频工坊模板分享文件", en: "Not a Commerce Video Studio template share file" },
  unsupported_version: {
    zh: "模板文件版本比当前应用新，请先升级电商视频工坊",
    en: "Template file is newer than this app; please upgrade Commerce Video Studio",
  },
